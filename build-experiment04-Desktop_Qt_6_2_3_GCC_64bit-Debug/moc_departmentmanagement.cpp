...
#include <memory>
#include "../experiment04/departmentmanagement.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DepartmentManagement_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DepartmentManagement_t qt_meta_stringdata_DepartmentManagement = {
    {
QT_MOC_LITERAL(0, 20) // "DepartmentManagement"
...
const QMetaObject DepartmentManagement::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DepartmentManagement.offsetsAndSize,
    qt_meta_data_DepartmentManagement,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DepartmentManagement_t
, QtPrivate::TypeAndForceComplete<DepartmentManagement, std::true_type>
