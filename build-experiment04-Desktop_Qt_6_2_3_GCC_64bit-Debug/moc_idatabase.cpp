...
#include <memory>
#include "../experiment04/idatabase.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_IDatabase_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_IDatabase_t qt_meta_stringdata_IDatabase = {
    {
QT_MOC_LITERAL(0, 9) // "IDatabase"
...
const QMetaObject IDatabase::staticMetaObject = { {
    ...
    qt_meta_stringdata_IDatabase.offsetsAndSize,
    qt_meta_data_IDatabase,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_IDatabase_t
...
void *IDatabase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IDatabase.stringdata0))
